...
<small>Auto-imported through easycom — no import statement needed.</small><br><small>Snippet from `uview-plus/src/pages/componentsC/calendar/calendar.nvue`</small>
...
<small>Auto-imported through easycom — no import statement needed.</small><br><small>Snippet from `uview-plus4/pages/componentsC/calendar/calendar.uvue`</small>
...
| --- | --- | --- | --- |
| `title` | 日历顶部标题 | `String` | `t("up.calendar.chooseDates")` |
| `showTitle` | 是否显示标题 | `Boolean` | `true` |
| `showSubtitle` | 是否显示副标题 | `Boolean` | `true` |
| `mode` | 日期类型选择，single-选择单个日期，multiple-可以选择多个日期，range-选择日期范围 | `String` | `'single'` |
| `startText` | mode=range时，第一个日期底部的提示文字 | `String` | `t("up.common.start")` |
| `endText` | mode=range时，最后一个日期底部的提示文字 | `String` | `t("up.common.end")` |
...
| `confirmText` | 确定按钮的文字 | `String` | `t("up.common.confirm")` |
| `confirmDisabledText` | 确认按钮处于禁用状态时的文字 | `String` | `t("up.common.confirm")` |
...
| `weekText` | 星期文案 | `Array` | `[t("up.week.one"), t("up.week.two"), t("up.we…` |
| `forbidDays` | — | `Array` | `[]` |
| `forbidDaysToast` | — | `String` | `t("up.calendar.disabled")` |
| `monthFormat` | — | `String` | `''` |
...
| uni-app · Vue 3 | `up-calendar` | `src/uni_modules/uview-plus/components/u-calendar` |
