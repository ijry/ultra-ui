...
<small>示例来源 `ultra-ui-hos/sample/entry/src/main/ets/demos/TextareaDemo.ets`</small>
...
<small>示例来源 `ultra-ui-flutter/example/lib/pages/components_c/textarea_page.dart`</small>
